...
fn parse_key(byte: u8) -> enigo::Key {
    match byte {
        ...
        b if b == Key::Backtick as u8 => enigo::Key::Layout('`'),
        ...
        b if b == Key::Slash as u8 => enigo::Key::Layout('?'), // TODO: This is weird

        b if b == Key::Tilde as u8 => enigo::Key::Layout('~'),
        b if b == Key::Exclamation as u8 => enigo::Key::Layout('!'),
        b if b == Key::At as u8 => enigo::Key::Layout('@'),
        b if b == Key::Hash as u8 => enigo::Key::Layout('#'),
        b if b == Key::Dollar as u8 => enigo::Key::Layout('$'),
        b if b == Key::Percent as u8 => enigo::Key::Layout('%'),
        b if b == Key::Caret as u8 => enigo::Key::Layout('^'),
        b if b == Key::Ampersand as u8 => enigo::Key::Layout('&'),
        b if b == Key::Asterisk as u8 => enigo::Key::Layout('*'),
        b if b == Key::LeftParen as u8 => enigo::Key::Layout('('),
        b if b == Key::RightParen as u8 => enigo::Key::Layout(')'),
        b if b == Key::Underscore as u8 => enigo::Key::Layout('_'),
        b if b == Key::Plus as u8 => enigo::Key::Layout('+'),
        b if b == Key::LeftCurly as u8 => enigo::Key::Layout('{'),
        b if b == Key::RightCurly as u8 => enigo::Key::Layout('}'),
        b if b == Key::Pipe as u8 => enigo::Key::Layout('|'),
        b if b == Key::Colon as u8 => enigo::Key::Layout(':'),
        b if b == Key::DoubleQuote as u8 => enigo::Key::Layout('"'),
        b if b == Key::Less as u8 => enigo::Key::Layout('<'),
        b if b == Key::Greater as u8 => enigo::Key::Layout('>'),
        b if b == Key::Question as u8 => enigo::Key::Layout('?'),
...
pub fn parse_key_name(name: &str) -> Option<Key> {
    match name {
        ...
        "exclamation" => Some(Key::Exclamation),
        "at" => Some(Key::At),
        "hash" => Some(Key::Hash),
        "dollar" => Some(Key::Dollar),
        "percent" => Some(Key::Percent),
        "caret" => Some(Key::Caret),
        "ampersand" => Some(Key::Ampersand),
        "asterisk" => Some(Key::Asterisk),
        "lerfparen" => Some(Key::LeftParen),
        "rightparen" => Some(Key::RightParen),
        "underscore" => Some(Key::Underscore),
        "plus" => Some(Key::Plus),
        "leftcurly" => Some(Key::LeftCurly),
        "rightcurly" => Some(Key::RightCurly),
        "pipe" => Some(Key::Pipe),
        "colon" => Some(Key::Colon),
        "doublequote" => Some(Key::DoubleQuote),
        "less" => Some(Key::Less),
        "greater" => Some(Key::Greater),
