...
impl super::Context {
    ...
    fn mouse_event(&mut self, event_type: u32, button_number: u8, down: bool) -> bool {
        let mut event = io::NXEventData::default();
    ...
    pub fn mouse_down(&mut self, button: MouseButton) -> bool {
        ...
        if !self.mouse_event(event_type, button_number, true) {
            return false;
        }
    ...
    pub fn mouse_up(&mut self, button: MouseButton) -> bool {
        ...
        if !self.mouse_event(event_type, button_number, false) {
            return false;
        }
        self.button_state &= !(1 << button_number);
        true
    ...
    pub fn mouse_click(&mut self, button: MouseButton) -> bool {
