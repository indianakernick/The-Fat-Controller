...
Tick messages are being sent. The SocketManager does everything that it's
...
more pleasant than a web page. A webpage is easy to get setup but a native app
is worth the effort. I have more control. It feels rigid. I have the full
capabilities of the full available.
